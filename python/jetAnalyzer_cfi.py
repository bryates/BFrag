...
analysis = cms.EDAnalyzer("JetAnalyzer",
                          ...
                          muTriggersToUse = cms.vstring('HLT_IsoMu24_v', 'HLT_IsoTkMu24_v', 'HLT_IsoMu27_v',
                                                        'HLT_IsoMu22_eta2p1_v', 'HLT_IsoTkMu22_eta2p1_v',
                                                        'HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v', 'HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v'),
                          elTriggersToUse = cms.vstring('HLT_Ele27_WPTight_Gsf_v', 'HLT_Ele32_WPTight_Gsf_v', 'HLT_Ele35_WPTight_Gsf_v', 
